...
module.exports = __webpack_require__(/*! D:\angularProjects\employeemanagerapp\src\main.ts */"zUnb");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 1, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ providers: [_employee_service__WEBPACK_IMPORTED_MODULE_2__["EmployeeService"]], imports: [[
...
class EmployeeService {
    constructor(http) {
        this.http = http;
        this.apiServeUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiBaseUrl;
    }
    getEmployees() {
        return this.http.get(`${this.apiServeUrl}/employee/all`);
    }
    addEmployee(employee) {
        return this.http.post(`${this.apiServeUrl}/employee/add`, employee);
    }
    updateEmployee(employee) {
        return this.http.put(`${this.apiServeUrl}/employee/update`, employee);
    }
    deleteEmployee(employeeId) {
        return this.http.delete(`${this.apiServeUrl}/employee/delete/${employeeId}`);
    }
}
